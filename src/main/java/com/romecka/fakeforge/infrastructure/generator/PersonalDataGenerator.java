...
import static com.romecka.fakeforge.utils.CsvUtils.fromCsv;
...
public class PersonalDataGenerator {
    ...
    private static final String FEMALE_LAST_NAMES_FILE = "src/main/resources/data/female_last_names.csv";

    private static final String FEMALE_FIRST_NAMES_FILE = "src/main/resources/data/female_first_names.csv";

    private static final String MALE_FIRST_NAMES_FILE = "src/main/resources/data/male_first_names.csv";

    private static final String MALE_LAST_NAMES_FILE = "src/main/resources/data/male_last_names.csv";

    static {
        FEMALE_FIRST_NAMES = fromCsv(FEMALE_FIRST_NAMES_FILE);
        FEMALE_LAST_NAMES = fromCsv(FEMALE_LAST_NAMES_FILE);
        MALE_FIRST_NAMES = fromCsv(MALE_FIRST_NAMES_FILE);
        MALE_LAST_NAMES = fromCsv(MALE_LAST_NAMES_FILE);
    }
